...
FLASK_MERCADOPAGO_PATH = CURRENT_PATH.parent.parent

sys.path.insert(0, str(FLASK_MERCADOPAGO_PATH))

import flask_mercadopago


# -- Project information -----------------------------------------------------

project = 'Flask-Mercadopago'
copyright = f'{datetime.date.today().year}, Ferreira, Juan David'
author = 'Ferreira, Juan David'

# The full version, including alpha/beta/rc tags
release = flask_mercadopago.__version__
